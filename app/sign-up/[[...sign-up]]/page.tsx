      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-[#27187e] text-white p-16 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-white/80 max-w-md font-medium mb-12">
            Create an account to browse premium courses, buy exact chapters you need, and interact with expert instructors.
          </p>

          <div className="space-y-4">
            {['Pay only for what you learn', 'Local payments via Easypaisa/JazzCash', 'Targeted Class 9-12 curriculum'].map((item, i) => (
        ...
        <div className="relative z-10 bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 mt-12">
          <p className="italic text-white/90 font-medium mb-4">
            "Finally a platform built specifically for Pakistani students. The video quality and teaching style are unmatched."
          </p>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#4A5043] flex items-center justify-center font-bold">F</div>
            <div>
              <div className="font-bold">Fatima Tariq</div>
              <div className="text-sm text-white/70">Matric Student</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 xl:p-24 relative">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10 lg:mb-12">
            <h2 className="text-3xl font-black text-[#27187e] mb-2">Create an Account</h2>
            <p className="text-[#4A5043] font-medium">Join Zanrosh Academy and excel in your exams.</p>
          </div>
