    ...
    try {
      const res = await fetch('/api/chapters', {
        ...
        body: JSON.stringify({
          ...
          price: form.price === '' || isNaN(parseFloat(form.price)) ? 400 : parseFloat(form.price),
          accessDays: form.accessDays === '' || isNaN(parseInt(form.accessDays)) ? 15 : parseInt(form.accessDays),
          order: nextOrder,
          isFree: form.isFree,
